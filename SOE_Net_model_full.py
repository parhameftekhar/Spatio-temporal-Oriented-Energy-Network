...
def TPR(name, C):
    ...
    # a = tf.math.count_nonzero(C_plus_minus)
    # b = tf.size(C_plus_minus)
    return C_plus_minus
...
#         x = SC3D('conv1', video, basis, orientations, biases)
#         if cfg.REC_STYLE == 'two_path':
#             # a , b = TPR('Rec1', x)
#             # return b 
#             x = TPR('Rec1', x)
...
#         x = DivNorm3d('norm1', x, cfg.EPSILON)
        
#         x = SP3D('sp1', x, cfg.NUML, 0)
#         x = CP3D('cp1', x, 0)
#         print(x)

#     with tf.name_scope('Layer2'):
#         x = SC3D('conv2', x, basis, orientations, biases)
#         if cfg.REC_STYLE == 'two_path':
#             x = TPR('Rec2', x)
#         else:
#             x = FWR('Rec2', x)
            
#         x = DivNorm3d('norm2', x, cfg.EPSILON)
        
#         x = SP3D('sp2', x, cfg.NUML, 1)
#         x = CP3D('cp2', x, 1)
#         print(x)
#     with tf.name_scope('Layer3'):
#         x = SC3D('conv3', x, basis, orientations, biases)
#         if cfg.REC_STYLE == 'two_path':
#             x = TPR('Rec3', x)
#         else:
#             x = FWR('Rec3', x)
            
#         x = DivNorm3d('norm3', x, cfg.EPSILON)
        
#         x = SP3D('sp3', x, cfg.NUML, 2)
#         x = CP3D('cp3', x, 2)  
#         print(x)
#     with tf.name_scope('Layer4'):
#         x = SC3D('conv4', x, basis, orientations, biases)
#         if cfg.REC_STYLE == 'two_path':
#             x = TPR('Rec4', x)
#         else:
#             x = FWR('Rec4', x)
            
#         x = DivNorm3d('norm4', x, cfg.EPSILON)
        
#         x = SP3D('sp4', x, cfg.NUML, 2)
#         x = CP3D('cp4', x, 2)  
#         print(x)       
#     with tf.name_scope('Layer5'):
#         x = SC3D('conv5', x, basis, orientations, biases)
#         if cfg.REC_STYLE == 'two_path':
#             x = TPR('Rec5', x)
#         else:
#             x = FWR('Rec5', x)
            
#         x = DivNorm3d('norm5', x, cfg.EPSILON)
#         x = GSP('GSP',x)
#         print(x)
#     return x
...
def SOE_Net(video, basis, orientations, biases):
    ...
    #     norm4 = DivNorm3d('norm4', rec4, cfg.EPSILON)
        # feat = GSP('GSP',norm4)
        # sp4 = SP3D('sp4', norm4, cfg.NUML, 3)
        # cp4 = CP3D('cp4', sp4)
        # print(cp4.get_shape())
        # # print(sp4, cp4)        
    # with tf.name_scope('Layer5'):
    #     conv5 = SC3D('conv5', cp4, basis, orientations, biases)
    #     if cfg.REC_STYLE == 'two_path':
    #         rec5 = TPR('Rec5', conv5)
    #     else:
    #         rec5 = FWR('Rec5', conv5)
            
    #     norm5 = DivNorm3d('norm5', rec5, cfg.EPSILON)
    #     feat = GSP('GSP',norm5)
